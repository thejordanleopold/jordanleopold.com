# One entry per book. Fields: title, author, status (reading|read|textbook), edition (optional), year (optional), cover (optional), note (optional), stars (1-5, optional), subject (optional), subsubject (optional)
